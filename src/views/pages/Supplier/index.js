...
export default class Supplier extends React.Component {
  constructor(props) {
    super(props);
    this.state = props.supplierParams;
    ...
    this.stomp = StompClientFactory(Constants.MODEL_NAMES.SUPPLIER);
  }
  componentWillReceiveProps(props) {
    this.setState(props.supplierParams);
    this.shouldUpdate = !!this.state.id;
    this.acceptButtonLabel = this.shouldUpdate ? "Actualizar" : "Guardar";
  }
  update(name, e) {
  ...
  render() {
    let supplierName = this.state.name ? ": " + this.state.name : "";
    return (
